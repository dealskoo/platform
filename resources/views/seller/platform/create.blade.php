...
@section('title',__('platform::platform.add_platform'))
@section('body')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ __('platform::platform.add_platform') }}</li>
                    </ol>
                </div>
                <h4 class="page-title">{{ __('platform::platform.add_platform') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('seller.platforms.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <div class="avatar-box">
                                            <img src="{{ asset(config('platform.default_logo')) }}"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control" name="description" id="description" required tabindex="3"
                                          rows="4"
                                          placeholder="{{ __('platform::platform.description_placeholder') }}">{{ old('description') }}</textarea>
                            </div>
                        </div> <!-- end row -->
                        <div class="text-end">
